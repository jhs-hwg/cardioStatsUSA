...
Our goal is to provide a platform for exploration of the National Health and Nutrition Examination Survey (NHANES) data. We created this website to give context and documentation for users of the application, which can be accessed here: https://bcjaeger.shinyapps.io/nhanesShinyBP/
...
**Systolic blood pressure by age group in the last three NHANES cycles.**

```{r, echo = FALSE, fig.height=10, fig.width=10}
library(cardioStatsUSA)
nhanes_visualize(outcome_variable = 'bp_sys_mean', 
                 group_variable = 'demo_age_cat',
                 outcome_stats = c("mean"),
...
**Prevalence of blood pressure control by sex among adults with hypertension.**

```{r, echo = FALSE, fig.height=10, fig.width=10}
nhanes_visualize(outcome_variable = 'bp_control_accaha', 
                 group_variable = 'demo_gender',
                 outcome_stats = c("percentage"),
                 subset_calls = c("htn_accaha" = "Yes"),
                 time_values = 'all', 
                 title = "",
                 width = 800, 
                 height = 600)[[1]]
