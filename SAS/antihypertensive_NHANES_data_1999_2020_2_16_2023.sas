...
htpills2pl=0;
if htmeds=1 and n_aht_pills>=2 then htpills2pl=1;
run;
...
takingantiht antiht_mono antiht_combo antiht_threepl combination htpills2pl n_aht_pills; 
run;
...
if (avgsbp>=130 or avgdbp>=85) and hxcvd_hf=1 then escesh7tx=1;  
...
data l.final9920_02162023; set final9920; run;

data l.small9920_02162023; set final9920; 
...
proc export data=final9920 outfile= "C:\Users\pmuntner\Box\j_drive\Delzell\CVD\2022\NHANES_data_platform\Final_code\NHANES_0216_2023.dta" replace;
run;
...
by seqn;
if a*b;
n_single_pills=sum (of ACE,Aldo,Alpha,Alpha_beta,Angioten,Beta_cardio_nonselect,Beta_cardio_vasod,Beta_cardio_select,Beta_int_sym,Central,DhpCCB,NdhpCCB,Diur_Ksparing,
                     Diur_loop,Diur_thz_like,Diur_thz_type,Renin_inhibitors,Vasod);
