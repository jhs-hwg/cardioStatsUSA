...
libname lei2 "O:\REGARDS\NHANES_data\antiht_meds20092014\updated_12_2022_utah";
data antihtmeds; set lei2.seqn_antihyper_9900_1720; antihtavailable=1; 
keep seqn ace aldo alpha angioten beta ccb central diur_ksparing diur_loop diur_thz renin_inhibitors vasod combination med_infox;
run;
...
RIDEXPRG 
num_htn_class ace aldo alpha angioten beta central ccb diur_Ksparing diur_loop diur_thz Renin_inhibitors vasod 
takingantiht antiht_mono antiht_combo antiht_threepl combination; 
run;
...
data l.final9920_1201022; set final9920; run;

data l.small9920_12012022; set final9920; 
...
ace aldo alpha angioten beta central ccb diur_Ksparing diur_loop diur_thz Renin_inhibitors vasod rht_jnc7thz rht_accahathz combination;
run;

proc export data=final9920 outfile= "C:\Users\pmuntner\Box\j_drive\Delzell\CVD\2022\NHANES_data_platform\Final_code\NHANES_1201_2022.dta" replace;
run;
...
**** NOW ITS THE ICOMBINATION MEDICATION USE;
**** NOW ITS THE ICOMBINATION MEDICATION USE;
**** NOW ITS THE ICOMBINATION MEDICATION USE;
...
%let GNN14=TELMISARTAN/AMLODIPINE;
%let GNN15=VALSARTAN/AMLODIPINE;
...
%let GNN43=HYDRALAZINE/HYDROCHLOROTHIAZIDE;
%let GNN44=OLMESARTAN/AMLODIPINE/HYDROCHLOROTHIAZIDE;
%let GNN45=VALSARTAN/AMLODIPINE/HYDROCHLOROTHIAZIDE;
%let GNN46=HYDRALAZINE/HYDROCHLOROTHIAZIDE/RESERPINE;
...
%let NGNN14=TELMISARTAN_AMLODIPINE;
%let NGNN15=VALSARTAN_AMLODIPINE;
...
%let NGNN43=HYDRALAZINE_HCTZ;
%let NGNN44=OLMESARTAN_AMLODIPINE_HCTZ;
%let NGNN45=VALSARTAN_AMLODIPINE_HCTZ;
%let NGNN46=HYDRALAZINE_HCTZ_RESERPINE;
...
if CLONIDINE_CHLORTHALIDONE=1 then CenACT_thia_like=1;
...
if HYDRALAZINE_HCTZ_RESERPINE=1 then DirVaso_thia_type=1;
...
DirVaso_thia_type=1 then combination=1;else combination=0;
...
label ACEI_dihy_CCB="ACEI/Dihydropyridine CCB"
	...
	DirVaso_thia_type="Direct vasodilator/thiazide-type diuretic/centrally-acting"
;
run;
...
/*proc freq data=T3;tables ACEI_dihy_CCB ACEI_non_dihy_CCB ACEI_thia_diur Aldo_thia_diur Alpha_thia_diur ARB_dihy_CCB ARB_thia_like ARB_thia_type Beta_thia_like
	Beta_thia_type BetaAlpha_thia_type BetanonCard_thia_type CenACT_thia_like CenACT_thia_type DirRenin_ARB DirRenin_thia_type Potass_thia_type DirVaso_thia_type
	 ARBdihy_thia_type DirVaso_thia_type;run;*/
...
merge save.seqn_antihyper_v3_com_&yr. (in=a keep=seqn yc ACEI_dihy_CCB ACEI_non_dihy_CCB ACEI_thia_diur Aldo_thia_diur Alpha_thia_diur ARB_dihy_CCB ARB_thia_like ARB_thia_type Beta_thia_like
												Beta_thia_type BetaAlpha_thia_type BetanonCard_thia_type CenACT_thia_like CenACT_thia_type DirRenin_ARB DirRenin_thia_type Potass_thia_type DirVaso_thia_type
												 ARBdihy_thia_type DirVaso_thia_type combination med_info rename=(med_info=med_infox yc=ycx))
...
/*libname comp "H:\studies\CVD\shared\Amgen Cardiac Collaboration\Users\Lei\LDLR\SAS xpt\update_11_2022\Update_20221130";

proc compare data=csav.seqn_antihyper_9900_1720 compare=com;run;
proc compare data=csav.seqn_antihyper_9900_1720 compare=comp.seqn_antihyper_9900_1720;run;*/


/*ods html;
proc contents data=csav.seqn_antihyper_9900_1720;run;
ods html close;*/
