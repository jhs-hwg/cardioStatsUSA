...
n_htn_1999 <- fig_main_3 %>% 
 getElement("fig_data") %>% 
 .[svy_year == '1999-2000' & htn_accaha == 'Yes'] %>% 
 .[, (est_cols) := lapply(.SD, function(x) table_value(x/1e6)), 
   .SDcols = est_cols] %>% 
 est_ci()
...
Among non-institutionalized US adults ≥ 18 years of age, the estimated mean SBP was `r sbp_1999` mm Hg in 1999-2000, `r sbp_2009` mm Hg in 2009-2010 and `r sbp_2017` mm Hg in 2017-2020 (**Figure 1**). The age-adjusted prevalence of hypertension defined as in the 2017 ACC/AHA BP guideline was highest in 1999-2000 (`r bracket_drop(htn_1999)`%), lowest in 2009-2010 (`r bracket_drop(htn_2009)` ), and `r bracket_drop(htn_2017)`% in 2017-2020 (**Figure 2**). In 1999-2000, there were an estimated `r n_htn_1999` million US adults with hypertension (**Figure 3**). The number of US adults with hypertension increased to `r n_htn_2017` million in 2017-2020.  In each NHANES cycle, the estimated prevalence of hypertension was higher among US adults with versus without CKD (**Figure S2**). In 2017-2020, a higher percentage of US adults with versus without hypertension were non-Hispanic Black (`r bracket_drop(htn_black_2017)`% versus `r bracket_drop(nrm_black_2017)`%) while a lower percentage of US adults with versus without hypertension were Hispanic (`r bracket_drop(htn_hispanic_2017)`% versus `r bracket_drop(nrm_hispanic_2017)`%) (**Table 2**). Among pregnant women, the distribution of BP categories could not be estimated reliably in 2017-2020 (**Figure S3; Panel A**), but it could be estimated reliably after pooling NHANES cycles from 2009-2010 through 2017-2020 (**Figure S3; Panel B**)

<br>

The age-adjusted prevalence of BP control defined as in the 2017 ACC/AHA BP guideline among non-pregnant US adults with hypertension was lowest in 1999-2000 (`r bracket_drop(bp_control_1999a)`%), highest in 2013-2014 (`r bracket_drop(bp_control_2013a)`%), and `r bracket_drop(bp_control_2017a)`% in 2017-2020 (**Figure 4; Panel A**). Among US adults with hypertension who self-reported taking antihypertensive medication, `r bracket_drop(bp_control_1999b)`%, `r bracket_drop(bp_control_2013b)`%, and `r bracket_drop(bp_control_2017b)`% had controlled BP in 1999-2000, 2013-2014, and 2017-2020, respectively (**Figure 4; Panel B**). The age-adjusted prevalence of resistant hypertension defined as in the 2017 ACC/AHA BP guideline among non-pregnant US adults with hypertension who self-reported taking antihypertensive medication and had ≥1 antihypertensive medication class identified during the medication inventory was lowest in 1999-2000 (`r bracket_drop(htn_resistant_1999a)`%), highest in 2005-2006 (`r bracket_drop(htn_resistant_2005a)`%), and `r bracket_drop(htn_resistant_2017a)`% in 2017-2020 (**Figure S4; Panel A**). Further restricting this analysis to those who were taking three or more classes of antihypertensive medication, the prevalence of resistant hypertension was `r bracket_drop(htn_resistant_1999b)`%,  `r bracket_drop(htn_resistant_2005b)`%, and `r bracket_drop(htn_resistant_2017b)`% in 1999-2000, 2005-2006, and 2017-2020, respectively (**Figure S4; Panel B**).
...
footer_hyperlink <- function(url){
 glue::glue(
  "This commands used to generate this graph are [available online]({url})"
 )
}
