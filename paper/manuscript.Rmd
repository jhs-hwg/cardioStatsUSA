...
htn_resistant_2009b <- fig_supp_4_b %>% 
 getElement("fig_data") %>% 
 .[svy_year == '2009-2010' & htn_resistant_accaha == 'Yes'] %>% 
 est_ci()

htn_resistant_2003b <- fig_supp_4_b %>% 
 getElement("fig_data") %>% 
 .[svy_year == '2003-2004' & htn_resistant_accaha == 'Yes'] %>% 
 est_ci()
