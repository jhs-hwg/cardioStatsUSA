...
nhanes_variables <- tibble::tribble(
                    ...
                    "Demographics",                          "demo_race",                                                                              "Race/ethnicity",      "DEMO", "catg",     TRUE,   TRUE,    TRUE,      TRUE,   "htn",
     ...
     "Antihypertensive medication",                 "bp_med_combination",                                                                         "Combination therapy",       "RXQ", "bnry",     TRUE,   TRUE,    TRUE,      TRUE,   "htn",
...
variable_description <- tibble::tribble(
 ...
 "bp_med_combination", "Taking a single pill with two classes of antihypertensive medication.",
 ...
 "bp_med_angioten", "Taking an angiotensin receptor blocker, defined using the pill bottle review. Drugs in this class included azilsartan, candesartan, eprosartan, irbesartan, losartan, olmesartan, telmisartan, valsartan.",
 "bp_med_beta", "Taking a beta blocker. Drugs in this class included acebutolol, atenolol, betaxolol, bisoprolol, carvedilol, labetalol, metoprolol, nadolol, nebivolol, pindolol, penbutolol, propranolol, timolol.",
 ...
 "bp_med_central", "Taking a centrally acting agents, defined using the pill bottle review. Drugs in this class included clonidine, guanabenz, guanadrel, guanethidine, guanfacine, methyldopa, reserpine.",
 ...
 "bp_med_diur_thz", "Taking a thiazide diuretic, defined using the pill bottle review. Drugs in this class included bendroflumethiazide, chlorthalidone, chlorothiazide, hydrochlorothiazide, hydroflumethiazide, indapamide, metolazone, methyclothiazide, trichlormethiazide.",
